...
public class BillPrintPharmacy extends javax.swing.JFrame {
    String name="";
    String batchno="";
    String qty="";
    String price="";
    ...
    /**
     * Creates new form BillPrintPharmacy
     */
    public BillPrintPharmacy() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel1.setBackground(new java.awt.Color(255, 255, 255,125));
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, -50, 330, 1030));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Sno", "Name", "Batch no", "Quantity", "Price"
            }
        ));
        jScrollPane1.setViewportView(jTable1);

        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 120, 940, -1));

        jLabel2.setText("jLabel2");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(1090, 580, 210, 40));
    ...
    public void setValues(String a,String b,String c,String d,String e,String f){
        ...
        jLabel2.setText("Grand Total"+grandtotal);
        DefaultTableModel dtm=(DefaultTableModel)jTable1.getModel();
        dtm.addRow(new Object[]{name,batchno,qty,price,total});
    }
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BillPrintPharmacy.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BillPrintPharmacy().setVisible(true);
            }
        });
    }
